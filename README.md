...
- Käyttäjä pystyy valitsemaan kirjan hyllynäkymästä ja siirtymään kirjanäkymään. Hyllynäkymässä käyttäjä voi myös poistaa kirjoja.
- Kirjanäkymässä käyttäjä voi muokata kirjan tietoja.
